...
class KingJamesParserTest < Minitest::Test
  ...
  def test_start_of_verse_with_zero
    assert @parser.start_of_verse?("1:10 And God called the dry land Earth; and the")
  end

  def test_get_chapter_from_verse
    assert_equal 1, @parser.get_chapter_from_verse("1:10 And God called the dry land Earth")
  end
  ...
  def test_strip_verse_number
    assert_equal "And God called the dry land Earth",
                 @parser.strip_verse_number("1:10 And God called the dry land Earth")
  end
end
